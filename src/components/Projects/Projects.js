  ...
  return (
    <div className="projects_container">
      <div className="project1">
        ...
        <p>
          The e-commerce project aims to create an online platform that enables
          businesses to sell their products or services directly to customers
          over the internet. The platform will allow customers to browse through
        ...
        <p>
          ...
          navigate through the site and find what they're looking for.
        </p>
      </div>
      <hr />
      <hr />
      ...
      <div className="">
        ...
        <p>
          The CRM app project aims to create a web or mobile application that
          allows businesses to manage their customer relationships effectively.
          The application will enable businesses to store and organize customer
          data, track customer interactions and activities, and analyze customer
          behavior to improve engagement and sales.
        </p>

        <p>
          The project will include features such as user registration and login,
          customer data management, lead and opportunity tracking, sales
          forecasting, communication and collaboration tools, reporting and
          analytics, and integration with other business systems such as
          marketing automation and e-commerce platforms.
        </p>

        <p>
          The CRM app will be designed to be user-friendly and customizable,
          allowing businesses to tailor the application to their specific needs
